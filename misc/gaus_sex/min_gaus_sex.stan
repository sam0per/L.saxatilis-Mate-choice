...
parameters {
  ...
  vector<lower=-10, upper=10>[N_shore] lambda1;
  //real lambda1_mu;
  //real<lower=0> lambda1_sd;
  vector<lower=-10, upper=10>[N_eco] lambda2;
  //real lambda2_mu;
  //real<lower=0> lambda2_sd;
  vector<lower=-10, upper=10>[N_sex] lambda3;
  //real lambda3_mu;
